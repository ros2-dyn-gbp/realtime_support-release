...
%global pkg_name tlsf_cpp
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-rolling-tlsf-cpp
Version:        0.17.0
Release:        2%{?dist}
Summary:        ROS %{pkg_name} package

License:        GNU Lesser Public License 2.1 and Apache License 2.0
...
%changelog
* Fri Mar 22 2024 Brandon Ong <brandon@openrobotics.org> - 0.17.0-2
